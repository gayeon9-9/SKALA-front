// 버튼을 눌러야 시작하는 Up & Down 게임
// HTML에서 onclick="startGame()"을 호출하면 이 상자 안의 코드가 실행됨
function startGame() { // startGane이라는 이름의 함수를 만드는 코드 (나중에 startGame(); 이라고 호출해야 안의 코드가 실행됨)
